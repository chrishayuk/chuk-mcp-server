...
class MCPClient:
    ...
    async def send_request(self, method: str, params: Dict[str, Any] = None) -> Dict[str, Any]:
        ...
        try:
            async with self.session.post(self.server_url, json=request, headers=headers) as response:
    ...
    async def initialize(self) -> bool:
        ...
        response = await self.send_request(
            "initialize",
            {
                ...
                "clientInfo": {"name": "python-mcp-inspector", "version": "1.0.0"},
...
async def main():
    ...
    parser.add_argument(
        "-i", "--interactive", action="store_true", help="Enable interactive mode for testing tools and resources"
    )
