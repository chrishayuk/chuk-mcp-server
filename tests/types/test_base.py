...
def test_chuk_mcp_imports():
    ...
    from chuk_mcp_server.types.base import (
        ...
        MCPResource, MCPTool, MCPToolInputSchema
    )
...
def test_content_helper_imports():
    ...
    from chuk_mcp_server.types.base import (
        ...
        create_embedded_resource, content_to_dict, parse_content
    )
...
def test_error_type_imports():
    ...
    from chuk_mcp_server.types.base import (
        MCPError, ProtocolError, ValidationError
    )
...
def test_versioning_imports():
    ...
    from chuk_mcp_server.types.base import (
        CURRENT_VERSION, SUPPORTED_VERSIONS, ProtocolVersion
    )
...
def test_server_info_creation():
    ...
    server_info_with_title = ServerInfo(
        name="Test Server",
        version="1.0.0",
...
def test_content_creation():
    ...
    from chuk_mcp_server.types.base import (
        create_text_content, create_image_content, content_to_dict
    )
    ...
    for name, obj in module_dict.items():
        if hasattr(obj, '__module__'):
            ...
            if module_name and 'chuk_mcp_server' in module_name:
                ...
                assert module_name == 'chuk_mcp_server.types.base', \
                    f"Unexpected internal dependency: {module_name}"
