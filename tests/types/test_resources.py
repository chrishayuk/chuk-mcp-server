...
def test_resource_handler_cache_info():
    ...
    handler_no_cache = ResourceHandler.from_function(
        uri="test://no_cache",
        func=test_resource
    )
    ...
    handler_with_cache = ResourceHandler.from_function(
        uri="test://with_cache",
        func=test_resource,
        cache_ttl=60
    )
...
def test_create_resource_from_function_utility():
    ...
    handler = create_resource_from_function(
        uri="test://utility",
        func=utility_resource,
        name="Utility Resource",
        description="A utility resource"
    )
...
def test_create_markdown_resource_utility():
    ...
    handler = create_markdown_resource(
        uri="test://md_util",
        func=markdown_content,
