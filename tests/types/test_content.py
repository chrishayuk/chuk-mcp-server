...
def test_format_content_existing_content_objects():
    ...
    from chuk_mcp_server.types.content import format_content
    from chuk_mcp_server.types.base import create_text_content, create_image_content
...
def test_content_formatting_edge_cases():
    ...
    from chuk_mcp_server.types.content import format_content, format_content_as_text, format_content_as_json
