...
class PromptHandler:
    ...
    def from_function(cls, func: Callable, name: Optional[str] = None, 
                     description: Optional[str] = None) -> 'PromptHandler':
    ...
    @property
    def arguments(self) -> Optional[List[Dict[str, Any]]]:
    ...
    async def get_prompt(self, arguments: Optional[Dict[str, Any]] = None) -> Union[str, Dict[str, Any]]:
        """
        ...
        try:
            ...
            raise MCPError(f"Failed to generate prompt '{self.name}': {str(e)}", code=-32603)

# ============================================================================
# Prompt Creation Utilities
# ============================================================================

def create_prompt_from_function(func: Callable, name: Optional[str] = None, 
                               description: Optional[str] = None) -> PromptHandler:
